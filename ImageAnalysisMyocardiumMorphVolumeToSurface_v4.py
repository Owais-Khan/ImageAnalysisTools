...
class ImageAnalysisMyocardiumMorphVolumeToSurface():
	...
	def Main(self):
		...
		#Get Volumetric Surface
		print ("--- Getting Surface of the MBF Volume")
		VolumetricSurface=ExtractSurface(Volume)

		#Smooth the surface
		print ("--- Smoothen the Surface to remove pointy edges")
		VolumetricSurfaceSmooth=SurfaceSmoothing(VolumetricSurface,1000,0.02,method="Taubin")
	
		print ("--- Assigning tags to the outer and inner walls")
		VolumetricSurfaceSmooth=TagOuterSurface(VolumetricSurfaceSmooth)
	
		#Get principal componenet analysis	
	...
	def ProjectVolumetoSurface(self,Volume,
